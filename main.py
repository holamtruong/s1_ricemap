...
def main():
    input_img=''#satelite imagery input directory
    output_img=''#output ARD directory
    ARD.S1_process(input_img,output_img)
    #output_img='F:/S1_gpt/out_img'
    file_list=[img for img in os.listdir(output_img if img[-4:] == '.tif']
    ...
    print('exporting...')
    result_path='F:/S1_gpt/rice_HG/result'
