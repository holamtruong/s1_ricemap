...
#
#       python ./download-all-2020-09-11_13-23-11.py
#
#    Download all files in a Metalink/CSV: (downloaded from ASF Vertex)
#
#       python ./download-all-2020-09-11_13-23-11.py /path/to/downloads.metalink localmetalink.metalink localcsv.csv
#
...
class bulk_downloader:
    def __init__(self):
        ...
        self.files = [ "https://datapool.asf.alaska.edu/GRD_HD/SA/S1A_IW_GRDH_1SDV_20200612T224545_20200612T224610_032990_03D241_DC8C.zip" ]
